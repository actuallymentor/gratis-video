...
### Added
- add bottom-left PWA install prompt pill
...
### Fixed
- preserve explicit telephoto camera shortcut zoom labels
...
### Fixed
- harden service-worker reload fallback and cache cleanup races
